...
export default function Dashboard() {
  ...
  const [transactions, setTransactions] = useState([
    { date: '2025-01-15', type: 'Deposit', amount: '+5.2 SOL', status: 'Completed' },
    { date: '2025-01-14', type: 'Ticket Purchase', amount: '-2.5 SOL', status: 'Completed' },
    { date: '2025-01-12', type: 'Win', amount: '+15.8 SOL', status: 'Completed' },
  ]);
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 pt-32 pb-20">
        ...
        >
          <h1 className="font-orbitron text-4xl md:text-5xl font-bold mb-8 text-glow-purple">
            Dashboard
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <Card className="bg-card border-border/50 p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-muted-foreground">Next Monthly Draw</p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 rounded-xl bg-primary/10 border border-primary/30">
                    <p className="text-sm mb-2">
                      <strong className="text-primary">2× Ticket Bonus</strong> for Monthly lottery
                    </p>
                    <p className="text-xs text-muted-foreground">
                      Pre-ordering gives you double tickets (max 250 total)
                    </p>
                  </div>
                  ...
                  <p className="text-xs text-muted-foreground text-center">
                    All draws and payouts run automatically via Solana smart contracts
                  </p>
                </div>
              ) : (
          ...
          <Card className="mt-8 bg-secondary/20 border-primary/30 p-6">
            <p className="text-center text-muted-foreground">
              <strong className="text-primary">Note:</strong> This is a demo interface. In production, all transactions will be processed through Solana smart contracts with full transparency and security.
            </p>
          </Card>
        </motion.div>
      </div>
