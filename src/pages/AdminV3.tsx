  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 relative z-10">
        <h1 className="text-4xl font-orbitron font-bold mb-8 text-center bg-gradient-to-r from-primary to-purple-400 bg-clip-text text-transparent">
          Admin Dashboard
        </h1>

        {/* Launch Countdown */}
        {!hasLaunched && (
          <Card className="p-6 mb-8 bg-card/50 backdrop-blur-sm border-primary/30">
            <div className="flex items-center justify-center gap-4">
              <Clock className="w-8 h-8 text-primary" />
              <div>
                <h2 className="text-xl font-orbitron font-bold">Launch Countdown</h2>
                <p className="text-3xl font-mono text-primary mt-2">{timeUntilLaunch}</p>
                <p className="text-sm text-muted-foreground mt-1">Until November 12, 2025 at 6 PM CET</p>
              </div>
            </div>
          </Card>
        )}
        ...
        <Card className="p-6 mb-8 bg-card/50 backdrop-blur-sm border-primary/30">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-2xl font-orbitron font-bold">Monthly Lottery</h2>
            <Button 
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="p-4 bg-background/50 rounded-lg">
              <p className="text-sm text-muted-foreground">Lottery Funds (70%)</p>
              <p className="text-2xl font-bold text-primary">{formatSOL(monthlyFinancials.lotteryFunds)} SOL</p>
            </div>
            <div className="p-4 bg-background/50 rounded-lg">
              <p className="text-sm text-muted-foreground">Creator Funds (30%)</p>
              <p className="text-2xl font-bold text-green-400">{formatSOL(monthlyFinancials.creatorFunds)} SOL</p>
            </div>
            <div className="p-4 bg-background/50 rounded-lg">
              <p className="text-sm text-muted-foreground">Operator Funds (30%)</p>
              <p className="text-2xl font-bold text-blue-400">{formatSOL(monthlyFinancials.operatorFunds)} SOL</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6 mb-8 bg-card/50 backdrop-blur-sm border-primary/30">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-2xl font-orbitron font-bold">Weekly Lottery</h2>
            <Button 
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 bg-background/50 rounded-lg">
              <p className="text-sm text-muted-foreground">Lottery Funds (70%)</p>
              <p className="text-2xl font-bold text-primary">{formatSOL(weeklyFinancials.lotteryFunds)} SOL</p>
            </div>
            <div className="p-4 bg-background/50 rounded-lg">
              <p className="text-sm text-muted-foreground">Operator Funds (30%)</p>
        ...
        <Card className="p-6 mb-8 bg-card/50 backdrop-blur-sm border-primary/30">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-2xl font-orbitron font-bold">Daily Lottery</h2>
            <Button 
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 bg-background/50 rounded-lg">
              <p className="text-sm text-muted-foreground">Lottery Funds (70%)</p>
              <p className="text-2xl font-bold text-primary">{formatSOL(dailyFinancials.lotteryFunds)} SOL</p>
            </div>
            <div className="p-4 bg-background/50 rounded-lg">
              <p className="text-sm text-muted-foreground">Operator Funds (30%)</p>
